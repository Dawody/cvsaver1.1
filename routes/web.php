...
//_______________________ALERT_RETPEAT____________________
Route::get('/alertrepeat','ApplicantController@alert');
Route::post('/applicant_info','ApplicantController@getapplicant');
Route::post('/delete_applicant_from_alert','ApplicantController@delete_applicant_apply_eval');
//___________________________________________________________________________


//____________________job_managment____________________________
...
//___________________________APP_FORM_____________________________________
...
//___________________OFFERS____________________________________
