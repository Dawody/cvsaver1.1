...
<div class="heading">
   ...
   <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" name="email" placeholder="Email" required="please enter email">
              ...
              <label for="date of job">Birth Date</label>
<br>
         <label class="label2" for="birth_date">click to choose date</label>
        <input type="text" class="datepicker" name="birth_date" required="please enter date" >
                <br><br>
  ...
  <option value="zimbabwean">Zimbabwean</option>
         ...
         <label class="label1" for="job">Jobs</label>
                <select  name="job_name" required="please enter job">
